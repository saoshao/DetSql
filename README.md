...
**DetSql**目的用于辅助手动测试，由于设置线程较小不利于大量请求时的被动扫描，建议使用时在白名单处设置测试域名或IP，如www.baidu.com，以此减少不必要的无效扫描，如下
![](https://files.mdnice.com/user/72769/61e3e046-856a-4795-aa7f-7b10f014629e.png)
正常很少会出现卡顿情况，同时建议使用最新版进行测试，经本人测试，未设置白名单扫描常见随机请求数量超过150以后仍未发现卡顿等异常，如下
![](https://files.mdnice.com/user/72769/acd57d44-16a7-4401-8bb0-6d7cf3375720.png)
